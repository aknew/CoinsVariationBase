...
**CVBController** - основной класс для взаимодействия между GUI и бекэндом, в qml представлен синглтоном с именем CVBApi из пакета CVB.api . Является мостиком между GUI и хранилищем данных\настройками и т.п.

...
*fullFormFields - список полей, отображаемых в полном виде записи. Структура елемента - имя поля из таблицы, тип поля (в данный момент их всего три - просто текст, еомбобокс и картинка, причем картинка требует рефаторинга)

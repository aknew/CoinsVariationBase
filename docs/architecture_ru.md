...
**CBBaseIconProvider** - провайдер изображений, наследник QQuickImageProvider. Служит для показа иконки (по факту крупного изображения) базы, или стандартной иконки базы (если в папке базы нет иконки), или иконки добавления новой базы ()сли там пункт добавить новую
...
**hyperlink - по сути тот же простой текст, но с кнопкой перехода на ссылуц

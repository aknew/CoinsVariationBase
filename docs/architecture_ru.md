...
* filters - предопределенные фильтры, массив, щбъекты в котором представляют из себя пары name-condition. condition это сразу sql-условие, и изменить его из интерфейса на данный момент нельзя.

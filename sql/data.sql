...
INSERT INTO "Types" VALUES(8,2,1,1730,1754,'Двухглавый орел, увенчанный двумя коронами со скипетром в правой лапе и державой в левой','В рамке, украшенной арабесками, розеткой сверху, двумя лавровыми ветвями по бокам и двумя перекрещенными пальмовыми внизу надпись "ПОЛУ|ШКА" и год третьей строкой',4.1,'При описании вариантов этого типа как основная база использовалась статья Г.С. Евдокимова (см. источники), тиражи даны по нему же',1,5);
INSERT INTO "Types" VALUES(9,3,1,1730,1754,'Двухглавый орел, увенчанный двумя коронами со скипетром в правой лапе и державой в левой','В рамке, украшенной арабесками, розеткой сверху, двумя лавровыми ветвями по бокам и двумя перекрещенными пальмовыми внизу надпись "ДЕН|ГА" и год третьей строкой',8.19,'При описании вариантов этого типа как основная база использовалась статья Г.С. Евдокимова (см. источники), тиражи даны по нему же',1,2);
INSERT INTO "Types" VALUES(10,4,1,1755,1757,'Одноглавый орёл в облаках с поднятыми крыльями, на правом крыле узорчатый щит, украшенный гирляндой цветов с вензелем императрицы E P, над щитом императорская корона, внизу под облаками обозначение монетного двора','Такой же одноглавый орёл в облаках со щитом как на аверсе, но на щите надпись 1|КОПЕ|IКА, а под облаками год',20.48,'Родным гуртом является надпись, все копейки с сетчатым гуртом - перечеканы без перегурчивания из крестовиков',1,3);
...
INSERT INTO "Types" VALUES(18,1,1,1700,1700,'Двухглавый орел, увенчаный тремя коронами','В поле надпись "ПОЛЪ|ПОЛУШКИ", под ней год АѰ','','Крайне редкая, но все же относящяяся к регулярному чекану монета',1,1);
...
INSERT INTO "Types" VALUES(21,3,1,1797,1801,'Вензель императора Павла I и императорская корона над ним','Надпись в 2 строки "1| ДЕНЬГА" под ней черта и год и монетный двор в 2 строки',5.12,NULL,1,5);

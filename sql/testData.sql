...
INSERT INTO "Types" VALUES(4,"Полушка","Медь",1718,1722,'Двухглавый орел под коронами','Надпись в четыре строки"ВРП|ПОЛУ|ШКА" и год',1.02,"Регулярный общегосударственный","Гладкий");
INSERT INTO "Types" VALUES(8,"Полушка","Медь",1730,1754,'Двухглавый орел, увенчанный двумя коронами со скипетром в правой лапе и державой в левой','В рамке, украшенной арабесками, розеткой сверху, двумя лавровыми ветвями по бокам и двумя перекрещенными пальмовыми внизу надпись "ПОЛУ|ШКА" и год третьей строкой',4.1,"Регулярный общегосударственный","Шнур вправо или влево (зависит от года)");
